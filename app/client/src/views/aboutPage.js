...
const AboutPage = () => {
  return (
    <div>
      ...
      <ul className="no-bullets">
        <li>
          Developed using React.js, Node.js, MongoDB and Express hosted on the{" "}
          <a
            target="_blank"
            rel="noopener noreferrer"
            href={process.env.REACT_APP_BCDEV_EXCHANGE_URL}
          >
            {process.env.REACT_APP_BCDEV_EXCHANGE_URL}
          </a>{" "}
          DevOps Environment.
        </li>
        <li>
