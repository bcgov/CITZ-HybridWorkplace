    ...
    <TabContext value={tabValue}>
      <Box>
        <Stack spacing={2}>
          ...
          >
            <Tab label={<Typography variant="body1" sx={{color: tabValue === "1" ? "button.main" : "neutral.main"}}>{`Users: ${props.searchData.users.length}`}</Typography>}value="1" />
            <Tab label={<Typography variant="body1" sx={{color: tabValue === "2" ? "button.main" : "neutral.main"}}>{`Posts: ${props.searchData.posts.length}`}</Typography>} value="2" />
            <Tab
              label={<Typography variant="body1" sx={{color: tabValue === "3" ? "button.main" : "neutral.main"}}>{`Communities: ${props.searchData.communities.length}`}</Typography>}
              value="3"
            />
          </Tabs>
        </Stack>
